...
pub struct rsb_type_t(pub ::std::os::raw::c_char);
...
#[repr(transparent)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub struct rsb_err_t(pub ::std::os::raw::c_int);
...
#[repr(transparent)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub struct rsb_trans_t(pub rsb_flags_t);
...
pub enum rsb_mif_t {
    ...
    RSB_MIF_INDEX_STORAGE_IN_BYTES__TO__SIZE_T = 1,
    #[doc = "< Index storage occupation per nnz, in bytes. (#rsb_real_t)"]
    RSB_MIF_INDEX_STORAGE_IN_BYTES_PER_NNZ__TO__RSB_REAL_T = 2,
    #[doc = "< Rows count(#rsb_coo_idx_t)"]
    RSB_MIF_MATRIX_ROWS__TO__RSB_COO_INDEX_T = 4,
    #[doc = "< Columns count (#rsb_coo_idx_t)"]
    RSB_MIF_MATRIX_COLS__TO__RSB_COO_INDEX_T = 8,
    #[doc = "< Nonzeroes count (#rsb_nnz_idx_t)"]
    RSB_MIF_MATRIX_NNZ__TO__RSB_NNZ_INDEX_T = 16,
    #[doc = "< Total size, in bytes (size_t)"]
    RSB_MIF_TOTAL_SIZE__TO__SIZE_T = 32,
    #[doc = "< Matrix flags (#rsb_flags_t)"]
    RSB_MIF_MATRIX_FLAGS__TO__RSB_FLAGS_T = 64,
    #[doc = "< Matrix type code (#rsb_type_t)"]
    RSB_MIF_MATRIX_TYPECODE__TO__RSB_TYPE_T = 128,
    #[doc = "< Matrix info string, only for #rsb_mtx_get_info_str() (#rsb_char_t*)"]
    RSB_MIF_MATRIX_INFO__TO__CHAR_P = 256,
    #[doc = "< Leaf submatrices count (#rsb_blk_idx_t)"]
    RSB_MIF_LEAVES_COUNT__TO__RSB_BLK_INDEX_T = 512,
}
extern "C" {
...
impl blas_handle_type {
    ...
    pub const blas_invalid_handle: blas_handle_type = blas_handle_type(261);
}
impl blas_handle_type {
    #[doc = "< Will give 1 if the handle is new."]
    pub const blas_new_handle: blas_handle_type = blas_handle_type(262);
}
impl blas_handle_type {
    #[doc = "< will give 1 if the handle is open."]
    pub const blas_open_handle: blas_handle_type = blas_handle_type(263);
}
impl blas_handle_type {
    #[doc = "< Will give 1 if the handle is valid (that is, after #BLAS_duscr_end/#BLAS_zuscr_end/#BLAS_cuscr_end/#BLAS_zuscr_end)."]
    pub const blas_valid_handle: blas_handle_type = blas_handle_type(264);
}
#[repr(transparent)]
#[doc = " The following are not fully implemented. Usable with #BLAS_usgp."]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub struct blas_handle_type(pub ::std::os::raw::c_uint);
#[repr(u32)]
#[doc = " The following are usable with #BLAS_usgp only."]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum blas_sparsity_optimization_type {
    #[doc = "< Will give 0."]
    blas_regular = 271,
    #[doc = "< Will give 1."]
    blas_irregular = 272,
...
pub enum blas_rsb_ext_type {
    ...
    blas_rsb_spmv_autotuning_on = 6660,
    ...
    blas_rsb_spmv_autotuning_off = 6661,
    ...
    blas_rsb_spmv_n_autotuning_on = 6662,
    #[doc = "< Turn on executing threads autotuning for untransposed #BLAS_dusmv, #BLAS_zusmv, #BLAS_susmv, #BLAS_cusmv. See #blas_rsb_spmv_autotuning_on. (EXPERIMENTAL)"]
    blas_rsb_spmv_n_autotuning_off = 6663,
    ...
    blas_rsb_spmv_t_autotuning_on = 6664,
    #[doc = "< Turn on executing threads autotuning for transposed #BLAS_dusmv, #BLAS_zusmv, #BLAS_susmv, #BLAS_cusmv. See #blas_rsb_spmv_autotuning_on. (EXPERIMENTAL)"]
    blas_rsb_spmv_t_autotuning_off = 6665,
